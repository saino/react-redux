var gesture = function(win) {
    ...
    //     if(!className || className.indexOf("lt-button") < 0){
    ...
    //     if(className && className.indexOf("lt-button") >= 0){
    //         lt.addClass(element,'active');

    //         setTimeout(function(){
    //             lt.removeClass(element,'active');
    //         },150);
    //     }
    // }

    // docEl.addEventListener('touchstart', buttonHandler, false);
